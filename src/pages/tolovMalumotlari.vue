            ...
            <div class="jonatish" v-if="!tayyor" style="height: 480px">
                ...
                <div class="col-5">
                    ...
                    <label for="">Adress</label>
                        ...
                        <div class="col-5">
                             <input type="radio" v-model="buyurtma.pay_type" value="1" name="x"> Plastik {{buyurtma.pay_type}}
                        </div>
                    </div>
                    <div class="row mt-3">
                    <div class="col-10">
                         <button 
                            ...
                            @click="buyurtmalar" 
                            style="padding: 8px 30px">Yuborish
                         </button>
                         <!-- {{$v.buyurtma}} -->
                    </div>
                </div>
...
export default {
   ...
   directives:{
    ...
    methods: {
       buyurtmalar(){
            let self = this;
            self.buyurtma.product_id = this.ProductID[0].id
             if(this.$v.buyurtma.$anyError == false){
                axios({
                    method: 'post',
                    url: '/buyurtma/create',
                    data: self.buyurtma
